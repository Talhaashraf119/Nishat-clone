...
const Navbar = () => {
  ...
  const loginform = async (e) => {
    e.preventDefault();
    try {
      let result = await axios.post('https://nishat-clone-backend.vercel.app/login', logininfo);
  ...
  const emailsubmit = async (e) => {
    ...
    try {
      let result = await axios.post('https://nishat-clone-backend.vercel.app/getemail', { email: logininfo.email, otp: optp });
      setEmail("");
      setIsForgotPasswordOpen(false);
  ...
  const changePassword = async (e) => {
    ...
    try {
      let result = await axios.put('https://nishat-clone-backend.vercel.app/resetpass', { email: logininfo.email, newPassword });
      if (result) {
