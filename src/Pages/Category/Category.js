...
const Category = () => {
  ...
  const { detaildata, setdetaildata } = useContext(ContextCreate);


    const fetchdata = async () => {
      try {
        let result = await axios.get("https://nishat-clone-backend.vercel.app/getdata");
      ...
      {role === "men" && (
        <div className="categories-container">
          <div className="category-card">
            ...
            >
              {" "}
              <img src="\sk-231_1-768x1024.jpg" alt="Pret" />
              <p>Cotton</p>
            </button>
          </div>
          <div className="category-card">
            ...
            >
              {" "}
              <img src="\SK487-2_550x.webp" alt="Unstitched" />
              <p>Unstitched</p>
            </button>
          </div>
        </div>
            ...
            {role === "men" &&
              getdata
               ...
               <Link to={`/detailpage/${item._id}`}>    <img
                      src={`https://nishat-clone-backend.vercel.app/${item.image}`}
                      alt={item.name}
