...
function Checkout() {
  ...
  const sendinformation = async () => {
    const products = data.map(item => ({
        image: `https://nishat-clone-backend.vercel.app/${item.image}`,
        title: item.title,
        size: item.size,
        color: item.color,
        price: item.price,
    ...
    try {
        const response = await fetch("https://nishat-clone-backend.vercel.app/email", {
            method: "POST",
            headers: {
  ...
  const makepayment = async () => {
    try {
      ...
      const response = await fetch("https://nishat-clone-backend.vercel.app/checkout", {
        method: "POST",
        headers: headers,
            ...
            data.map((item, index) => (
              <div className="order-item" key={index}>
                <div className="item-image">
                  <img src={`https://nishat-clone-backend.vercel.app/${item.image}`} alt="Item" />
